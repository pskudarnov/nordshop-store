  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "bg-[var(--primary)] text-[var(--primary-foreground)] shadow-[var(--shadow-soft)] hover:brightness-102 hover:shadow-[var(--shadow-soft-lg)] active:brightness-95",
        variant === "ghost" &&
          "border border-[var(--border)] bg-[var(--card)] text-[var(--foreground)] hover:bg-[var(--muted)] active:brightness-95",
        variant === "soft" &&
          "bg-[var(--secondary)] text-[var(--secondary-foreground)] hover:brightness-102 active:brightness-95",
        className,
      )}
      {...props}
    />
