...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const path = '/checkout';
  return {title: t('checkoutTitle'), description: t('checkoutDescription'), alternates: {canonical: urlFor(locale, path), languages: {ru: urlFor('ru', path), en: urlFor('en', path), 'x-default': urlFor('ru', path)}}, robots: {index: false, follow: true}};
}
